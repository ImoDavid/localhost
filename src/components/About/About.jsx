        ...
        >
          ...
          <Stack direction={['column', 'row']}>
            <Box width={['100%', '65%']} paddingY={'1.5rem'}>
              <StyledAbouttext>
                I'm a fullstack web developer with over four years of experience
                and a proven track record of translating complex requirements
                into elegant, responsive websites by weaving creativity and
                functionality together to craft compelling web interfaces that
                resonate with clients' ideas. Additionally, I develop robust,
                scalable APIs, manage databases efficiently, and ensure seamless
                integration between frontend and backend systems to deliver
                cohesive and high-performing web applications.
              </StyledAbouttext>
